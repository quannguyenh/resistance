...
public class RE_SamplingMain {
	...
	public static void main(String[] args) {
		...
		for (String file : new String[] { "/home/qn/RES_samplingSpectral/re/can_144.gv" }) {
			try {
				...
				for (double ratio : RATIOS) {
					...
					List<Edge> sample = EdgeSampling.randomSample(edges, ratio);
